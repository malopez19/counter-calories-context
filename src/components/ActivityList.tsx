...
export default function ActivityList() {
    ...
    //categoryName y isEmptyActivities fueron importadas del hook useActivity, este hook tiene el contexto de
    //la aplicación y se puede acceder a él desde cualquier componente
